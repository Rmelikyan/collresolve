/**
 * Nominal Yarko Drift on Flora Family Objects
 *
 * Given an initial state and body size, this program generates 8 Florks
 * Each body is given a randomized ejection velocity, scaled to size, from the parent position
 * These bodies are integrated forward under constant trasnverse yarkovsky drift
 * Drift rate is scaled to the size of the size of the bodies.
 *
 * Program should complete in about 24 hours
 *
 */
#include <stdio.h>
#include <string.h>
